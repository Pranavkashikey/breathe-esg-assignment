    ...
    <div className="min-h-screen bg-[#f7f7f5] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 flex-col justify-between p-12">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <span className="text-white font-bold text-lg tracking-tight">Breathe <span className="text-emerald-400">ESG</span></span>
        </div>
        ...
        <div className="relative">
          <p className="text-xs text-slate-600">© {new Date().getFullYear()} Breathe ESG. All rights reserved.</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 sm:px-12">
        ...
        <div className="lg:hidden flex items-center gap-2.5 mb-10">
          ...
          <span className="font-bold text-slate-800">Breathe <span className="text-emerald-600">ESG</span></span>
        </div>
