        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-10 h-14">
          ...
          <div className="flex items-center gap-6 sm:gap-10">
            <Link to="/" className="flex items-center gap-2 shrink-0">
              ...
              <span className="text-sm font-bold text-slate-800 tracking-tight hidden sm:block">Breathe <span className="text-emerald-600">ESG</span></span>
            </Link>
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-1 z-20 w-52 rounded-xl border border-slate-200 bg-white shadow-lg overflow-hidden">
                    <div className="px-4 py-3 border-b border-slate-100">
                      ...
                      <p className="text-xs text-slate-400 mt-0.5 truncate">{user?.organization?.name}</p>
                    </div>
                    <div className="p-1">
                      <button
